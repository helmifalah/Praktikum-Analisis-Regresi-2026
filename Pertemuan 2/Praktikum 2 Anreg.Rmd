...
data <- read_excel("C:\\Users\\Helmi Falah\\Documents\\Anreg Prak\\NSC-2025.xlsx", sheet="Sheet2")
...
Didapatkan nilai $\hat\beta_0 = 50.35333$ artinya nilai dugaan rataan indeks pembangunan manusia ketika rata-rata lama sekolah bernilai 0 tahun adalah 50.353%, akan tetapi nilai 0 tidak ada dalam selang pengamatan rata-rata lama sekolah sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut
...
Koefisien determinasi yang dihasilkan adalah 0.8884 atau 88.84% artinya keragaman persentase indeks Pembangunan Manusia yang dapat dijelaskan oleh Rata-rata lama sekolah adalah sebesar 88.84%, sisanya yaitu 11.16% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
